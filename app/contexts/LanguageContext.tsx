...
const translations = {
  pt: {
    ...
    "about.intro": "Sou um desenvolvedor Full Stack apaixonado por tecnologia e com uma base sólida em desenolvimento front-end e back-end. Minha jornada na programação é impulsionada pelo desejo de aprender, inovar e contribuir para projetos que fazem a diferença.",
    ...
    "projects.taskManager.title": "Task Manager App",
    "projects.taskManager.description": "Aplicação de gerenciamento de tarefas com funcionalidades de arrastar e soltar, categorização e lembretes automáticos.",
    ...
    "contact.description": "Estou sempre aberto a novas oportunidades e colaborações. Sinta-se à vontade para entrar em contato!",
    "contact.email": "Email",
  ...
  en: {
    ...
    "projects.ecommerce.title": "E-Commerce Platform",
    "projects.ecommerce.description": "A complete e-commerce platform with shopping cart, integrated payments, and admin panel for product management.",
    "projects.taskManager.title": "Task Manager App",
