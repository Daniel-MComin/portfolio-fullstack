...
const translations = {
  pt: {
    ...
    "about.description": "Estou sempre animado para enfrentar novos desafios. Acredito que a tecnologia tem o poder de transformar e estou comprometido em criar soluções que impactem positivamente as pessoas.",
    ...
    "projects.ecommerce.description": "Uma plataforma de gerenciamento de estoque, com classificação de produtos e dashboard interativo baseado nos produtos e valores cadastrados.",
